...
import static com.solidcode.apistore.exception.ErrorType.DUPLICATE_PRODUCT;
import static com.solidcode.apistore.exception.ErrorType.INVALID_FIELD;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<?> duplicateUserExceptionHandling(Exception exception, WebRequest request) {
    ...
    return createSingleErrorListResponse(DUPLICATE_PRODUCT, exception, null);
  }
